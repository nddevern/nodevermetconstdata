...
;In SMILE's enemy editor when you place Torizo in a room, change the speed1 value to change his behavior.
;0000 = he acts like BT
;0002 = he acts like GT.

;asm by Nodever2.
;Please let me know if there are any issues.

; Updated Oct 13 2024: Fixed comments to specify that 0002 is needed for GT; the old comments were misleading. Thanks to neen for assistance.
